...
class _TeacherSetupScreenState extends State<TeacherSetupScreen> {
  ...
  Future<void> _handleCompleteProfile() async {
    ...
    try {
      ...
      if (mounted) {
        StarlightUtils.showSuccessBox(context, tr('identitySolidifiedExcl'));
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                Text(tr('teacherIdentity'), style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: StarlightTheme.primaryBlue)),
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () {
                      ...
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (_) => const RoleSelectionScreen(currentRole: "teacher")),
                      );
                    },
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.auto_stories, size: 100, color: StarlightTheme.primaryBlue),
