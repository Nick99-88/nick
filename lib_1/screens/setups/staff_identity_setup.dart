...
class StaffIdentitySetupScreen extends StatefulWidget {
  const StaffIdentitySetupScreen({super.key});

  @override
  State<StaffIdentitySetupScreen> createState() => _StaffIdentitySetupScreenState();
}

class _StaffIdentitySetupScreenState extends State<StaffIdentitySetupScreen> {
  ...
  Future<void> _handleCompleteProfile() async {
    ...
    try {
      ...
      final payload = {
        ...
        "national_id": _cnicController.text,
      ...
      if (mounted) {
        StarlightUtils.showSuccessBox(context, tr('staffIdentitySolidified'));
