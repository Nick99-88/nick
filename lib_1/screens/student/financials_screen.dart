...
class StudentFinancialsScreen extends StatefulWidget {
  const StudentFinancialsScreen({super.key});

  @override
  State<StudentFinancialsScreen> createState() => _StudentFinancialsScreenState();
}

class _StudentFinancialsScreenState extends State<StudentFinancialsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('My Fee Records', style: TextStyle(color: Color(0xFF263238), fontWeight: FontWeight.bold)),
        centerTitle: false,
                      ...
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('No fee records found', style: TextStyle(color: Colors.grey[500])),
                            ],
                          ),
                        )
                      : RefreshIndicator(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.school_outlined, color: Colors.blue, size: 18),
              ),
          ...
          if (myStatus != null) ...[
            ...
            Row(
              children: [
                ...
                Text('Your Fee: ', style: TextStyle(fontSize: 11, color: Colors.grey[600])),
          ...
          Text('Type: ${type == 'staff' ? 'Staff Salary' : 'Student Fee'}',
