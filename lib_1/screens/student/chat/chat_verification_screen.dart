...
class StudentChatVerificationScreen extends StatefulWidget {
  const StudentChatVerificationScreen({super.key});

  @override
  State<StudentChatVerificationScreen> createState() => _StudentChatVerificationScreenState();
}

class _StudentChatVerificationScreenState extends State<StudentChatVerificationScreen> {
    ...
    if (verifiedPhone != null && verifiedPhone.isNotEmpty && isVerified) {
      ...
      if (mounted) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const StudentChatListScreen()),
        );
        return;
      }
    }
      ...
      if (firebaseSuccess) {
        ...
        if (user != null) {
          ...
          if (serverSuccess) {
            ...
            if (mounted) {
              StarlightUtils.showSuccessBox(context, "✅ Pakistan Phone Verified. Student Chat Access Granted.");
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => const StudentChatListScreen())
              );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Student Chat Gateway", style: TextStyle(fontWeight: FontWeight.bold)),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Text("Student Chat", style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Color(0xFF01579B))),
            ...
            Text(
              _otpSent
                  ...
                  : "Verify your Pakistan phone number to enable the student chat system.",
