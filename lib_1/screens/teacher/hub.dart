...
class TeacherHub extends StatefulWidget {
  const TeacherHub({super.key});

  @override
  State<TeacherHub> createState() => _TeacherHubState();
}

class _TeacherHubState extends State<TeacherHub> {
  @override
          ...
          children: [
            ...
            Expanded(
              child: _bigTile(
                icon: Icons.cloud,
                title: "Server IDE",
                subtitle: "Deploy & host",
                color: Colors.blue,
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const ServerIdeScreen()),
                ),
              ),
            ),
          ],
